  ...
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    scf.if %4#1 {
      ...
      scf.if %29 {
        ...
        %36 = memref.get_global @printed_doc : memref<1xi32>
        %37 = llvm.mlir.addressof @str11 : !llvm.ptr
        %38 = llvm.getelementptr %37[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<38 x i8>
        %39 = scf.while (%arg2 = %c0_i32) : (i32) -> i32 {
          %40 = affine.load %36[0] : memref<1xi32>
          %41 = arith.cmpi slt, %arg2, %40 : i32
          scf.condition(%41) %arg2 : i32
        } do {
        ^bb0(%arg2: i32):
          %40 = arith.index_cast %arg2 : i32 to index
          %41 = arith.muli %40, %c16 : index
          %42 = arith.index_cast %41 : index to i64
          %43 = llvm.getelementptr %27[%42] : (!llvm.ptr, i64) -> !llvm.ptr, i8
          %44 = llvm.load %43 : !llvm.ptr -> i32
          %45 = arith.addi %arg2, %c1_i32 : i32
          %46 = llvm.getelementptr %43[0, 1] : (!llvm.ptr) -> !llvm.ptr, !llvm.struct<(i32, f64)>
          %47 = llvm.load %46 : !llvm.ptr -> f64
          %48 = arith.index_cast %44 : i32 to index
          %49 = memref.load %12[%48] : memref<?xmemref<?xi8>>
          %50 = "polygeist.memref2pointer"(%49) : (memref<?xi8>) -> !llvm.ptr
          %51 = llvm.call @printf(%38, %45, %44, %47, %50) vararg(!llvm.func<i32 (ptr, ...)>) : (!llvm.ptr, i32, i32, f64, !llvm.ptr) -> i32
          %52 = arith.addi %arg2, %c1_i32 : i32
          scf.yield %52 : i32
        }
