module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  llvm.mlir.global internal constant @str15("Usage: %s [-n num_points] [-d dimensions] [-k clusters] [-i max_iterations] [-p]\0A\00") {addr_space = 0 : i32}
  ...
  func.func @kmeans_kernel(%arg0: memref<?xmemref<?xf64>>, %arg1: memref<?xmemref<?xf64>>, %arg2: memref<?xi32>, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %alloc_1 = memref.alloc(%8) : memref<?xmemref<?xf64>>
    ...
    scf.for %arg7 = %c0 to %9 step %c1 {
      ...
      %15 = arith.divui %14, %c8 : index
      %alloc_2 = memref.alloc(%15) : memref<?xf64>
      memref.store %alloc_2, %alloc_1[%arg7] : memref<?xmemref<?xf64>>
    }
    ...
    scf.for %arg7 = %c0 to %10 step %c1 {
      ...
      scf.for %arg8 = %c0 to %12 step %c1 {
        memref.store %c0_i32, %alloc[%arg8] : memref<?xi32>
        %15 = arith.index_cast %arg4 : i32 to index
        scf.for %arg9 = %c0 to %15 step %c1 {
          %16 = memref.load %alloc_1[%arg8] : memref<?xmemref<?xf64>>
          memref.store %cst_0, %16[%arg9] : memref<?xf64>
        }
      }
      %13 = arith.index_cast %arg3 : i32 to index
      scf.for %arg8 = %c0 to %13 step %c1 {
        %15 = arith.index_cast %arg5 : i32 to index
        %16:2 = scf.for %arg9 = %c0 to %15 step %c1 iter_args(%arg10 = %c0_i32, %arg11 = %cst) -> (i32, f64) {
          %21 = arith.index_cast %arg9 : index to i32
          %22 = arith.index_cast %arg4 : i32 to index
          %23 = scf.for %arg12 = %c0 to %22 step %c1 iter_args(%arg13 = %cst_0) -> (f64) {
            %27 = memref.load %arg0[%arg8] : memref<?xmemref<?xf64>>
            %28 = memref.load %27[%arg12] : memref<?xf64>
            %29 = memref.load %arg1[%arg9] : memref<?xmemref<?xf64>>
            %30 = memref.load %29[%arg12] : memref<?xf64>
            %31 = arith.subf %28, %30 : f64
            %32 = arith.mulf %31, %31 : f64
            %33 = arith.addf %arg13, %32 : f64
            scf.yield %33 : f64
          }
          %24 = arith.cmpf olt, %23, %arg11 : f64
          %25 = arith.select %24, %21, %arg10 : i32
          %26 = arith.select %24, %23, %arg11 : f64
          scf.yield %25, %26 : i32, f64
        }
        memref.store %16#0, %arg2[%arg8] : memref<?xi32>
        %17 = arith.index_cast %16#0 : i32 to index
        %18 = memref.load %alloc[%17] : memref<?xi32>
        %19 = arith.addi %18, %c1_i32 : i32
        memref.store %19, %alloc[%17] : memref<?xi32>
        %20 = arith.index_cast %arg4 : i32 to index
        scf.for %arg9 = %c0 to %20 step %c1 {
          %21 = arith.index_cast %16#0 : i32 to index
          %22 = memref.load %alloc_1[%21] : memref<?xmemref<?xf64>>
          %23 = memref.load %arg0[%arg8] : memref<?xmemref<?xf64>>
          %24 = memref.load %23[%arg9] : memref<?xf64>
          %25 = memref.load %22[%arg9] : memref<?xf64>
          %26 = arith.addf %25, %24 : f64
          memref.store %26, %22[%arg9] : memref<?xf64>
        }
      }
      %14 = arith.index_cast %arg5 : i32 to index
      scf.for %arg8 = %c0 to %14 step %c1 {
        %15 = memref.load %alloc[%arg8] : memref<?xi32>
        %16 = arith.cmpi sgt, %15, %c0_i32 : i32
        scf.if %16 {
          %17 = arith.index_cast %arg4 : i32 to index
          scf.for %arg9 = %c0 to %17 step %c1 {
            %18 = memref.load %arg1[%arg8] : memref<?xmemref<?xf64>>
            %19 = memref.load %alloc_1[%arg8] : memref<?xmemref<?xf64>>
            %20 = memref.load %19[%arg9] : memref<?xf64>
            %21 = arith.sitofp %15 : i32 to f64
            %22 = arith.divf %20, %21 : f64
            memref.store %22, %18[%arg9] : memref<?xf64>
          }
        }
      }
    }
    ...
    scf.for %arg7 = %c0 to %11 step %c1 {
      %12 = memref.load %alloc_1[%arg7] : memref<?xmemref<?xf64>>
      memref.dealloc %12 : memref<?xf64>
    }
    memref.dealloc %alloc_1 : memref<?xmemref<?xf64>>
          ...
          %25:6 = scf.if %24 -> (i32, i32, i32, i1, i32, i1) {
            ...
            %32:5 = scf.if %31 -> (i32, i32, i1, i32, i1) {
              ...
              scf.if %37 {
                ...
                %43 = llvm.getelementptr %42[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<82 x i8>
